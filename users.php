			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="users.php"><i class="fas fa-user-edit"></i> <span> Customize Users </span></a>
					...
					<div class="col-md-12 d-flex">
						<div class="card card-table flex-fill">
							<div class="card-header">
								<h4 class="card-title float-left mt-2">View Residents</h4>
										...
										<tbody>
											...
											if ($result->num_rows > 0) {
												while($row = $result->fetch_assoc()) {
													echo "<tr><td>". $row["userid"]. "</td><td>" . $row["fullname"]. "</td><td>" . $row["gender"]. "</td><td>" . $row["address"]. "</td><td>" . $row["username"]. "</td><td>" .$row["role"]."</td>";
