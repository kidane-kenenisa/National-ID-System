			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="verifycitizen.php"><i class="fab fa-searchengin"></i> <span> Find Citizen </span></a>
				...
				<div class="row">
					<div class="col-md-12 d-flex">
						<div class="card card-table flex-fill">
                            ...
                            <h3> WELLCOME TO CITIZENS IDENTITY VERIFICATION PAGE</h3></li>
								
							</div>
							<div class="card-body">
							<form class="example" method="GET" action="verifieddata.php" >
