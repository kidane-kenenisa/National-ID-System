      ...
      <div class="top-nav-search">
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="kebeleregister.php"><i class="far fa-registered"></i> <span> Register New Citizen </span></a>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
            <h2>ENTER DATA</h2><form action="kebeleaccount.php" method="POST" enctype="multipart/form-data" name="residentinfo">
