...
<body>
	<div class="main-wrapper">
		...
		<div class="sidebar" id="sidebar">
            ...
            <li class="active"> <a href="issuedid.php"><i class="fas fa-id-card"></i><span>Register Issued id </span></a>
				...
				<div class="row">
					<div class="col-md-12 d-flex">
						<div class="card card-table flex-fill">
							...
							<div class="card-body">
              <h2>Insert issued id's information here</h2>
                  <form action="issue.php" method="POST" enctype="multipart/form-data" name="residentinfo">
                    <label><b>ID</b></label>
                      <input type="text" placeholder="Enter residents id" name="id" required>
                       <label><b>First Name</b></label>
                      <input type="text" placeholder="Enter residents first name" name="fname" required>
                     <label><b>Last Name</b></label>
                     <input type="text" placeholder="Enter residents last name" name="lname" required>
