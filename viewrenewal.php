			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="viewrenewal.php"><i class="fas fa-redo"></i> <span> Renewal request </span></a>
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Renewal Request</h3> </div>
					</div>
					...
					$sql = "SELECT * from renewrequest  ORDER BY dates";
