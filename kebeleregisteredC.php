			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="kebeleregisteredC.php"><i class="fas fa-registered"></i> <span> Registerd citizens</span></a>
						...
						<li> <a href="kebeleaccount.php"><i class="far fa-user-circle"></i> <span>Account Update</span></a> </li>
								...
								<div class="table-responsive">
									<table class="table table-hover table-center">
										...
										<tbody><?php
										  ...
										  $sql = "SELECT * from registration  ORDER BY dates";
										  ...
										  if ($result->num_rows > 0) {
											  ...
											  while($row = $result->fetch_assoc()) {
												  ...
												  <td>".$row["status"];
												 echo '</td><td><a style="font-size:12px;" class="w3-btn w3-teal" href="promotelegality.php?id='.$row['regstrationid'].'">YES</a>';
											  
												 echo '</td><td><a style="font-size:12px;" class="w3-btn w3-red" href="kebeledelete.php?id='.$row['regstrationid'].'">Delete</a>';
												 $no++;
											  }
