        ...
        <div class="sidebar" id="sidebar">
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="active"> <a href="dashboardr.php"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a> </li>
				...
				<div class="row">
					<div class="col-md-12 d-flex">
						<div class="card card-table flex-fill">
							...
							<div class="card-body">
							<h4 class="color-white " style=" padding-left: 20px; line-height: 37px; color: rgb(10, 0, 0); font-family: 'Open Sans', 'sans-serif';"> You Are Successfully Loged In To Resident Offcer!.
							</div>
						</div>
					</div>
				</div>
